        ...
        <form onSubmit={handleSubmit} className={cn("space-y-6", formStep === "preview" && "hidden")}>
          ...
          <Card className="p-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
              ...
              <div>
                ...
                <input value={name} onChange={(e) => { const v = e.target.value.replace(/[^a-zA-Z\s.]/g, "").toUpperCase(); setName(v); clearError("name"); }} className={`input-field ${errors.name ? "border-destructive" : ""}`} placeholder="CAPITAL ONLY" />
          ...
          <Card className="p-6">
            ...
            <div className="space-y-4">
              ...
              <div className="mt-4">
                <FileUploadField
                  value={currentServiceDoc}
                  onChange={(name) => setCurrentServiceDoc(name)}
