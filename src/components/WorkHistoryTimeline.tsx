...
import { MapPin, Building2, Briefcase, Calendar, UserCog } from "lucide-react";
                ...
                >
                  ...
                  {entry.role && (
                    <div className="flex items-center gap-2 mb-2">
                      <UserCog className={`w-4 h-4 ${isLatest ? "text-primary" : "text-muted-foreground"}`} />
                  ...
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <span className={`${entry.role ? "text-sm text-muted-foreground" : "font-semibold"} ${!entry.role && isLatest ? "text-foreground" : ""}`}>
                      {entry.position}
                    </span>
                  </div>
